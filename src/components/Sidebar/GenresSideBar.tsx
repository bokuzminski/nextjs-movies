      ...
      <nav>
        ...
        <ul className="list-outside list-none pb-4">
          <Link href={"/"} className="flex items-center px-8">
            ...
            <li className="text-white px-2 font-light my-2">Popular</li>
          </Link>
          <Link href={"/"} className="flex items-center px-8">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <li className="text-white px-2 font-light my-2">Upcoming</li>
          </Link>
          <Link href={"/"} className="flex items-center px-8">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <li className="text-white px-2 font-light my-2">Top rated</li>
          </Link>
        </ul>
